...
// Clean Arabic text: strip Bismillah from verse 1 (API embeds it), remove waqf circles
const BISMILLAH="بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ";
const cleanAr=(text,surahNum,verseNum)=>{
  let t=text;
  // Remove problematic waqf/pause marks that render as circles
  t=t.replace(/[\u06D6-\u06DC\u06DE-\u06E4\u06E7\u06E8\u06EA-\u06ED]/g,"");
